    ...
    domain = Domain((
        Action(
            ...
            preconditions=(
                ('inc', 'py', 'by'),
                #('dec', 'by', 'py'),
                ('blank', 'px', 'by'),#blank at px,by
                ('at', 't', 'px', 'py'),
            ),
            effects=(
                neg(('blank', 'px', 'by')),#unflag blank
                neg(('at', 't', 'px', 'py')),#unflag px,py
                ('blank', 'px', 'py'),#flag "blank" at px,py
                ('at', 't', 'px', 'by'),#flag "at" at px,py
            ),
        ),
        Action(
            'move-down',
